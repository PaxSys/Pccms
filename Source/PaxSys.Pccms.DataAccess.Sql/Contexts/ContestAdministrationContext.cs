...
namespace PaxSys.Pccms.DataAccess.Sql.Contexts
{
    public class ContestAdministrationContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Contest>().Property(x => x.Id)
                .UseSqlServerIdentityColumn();
            modelBuilder.Entity<Group>().Property(x => x.Id)
                .UseSqlServerIdentityColumn();
            modelBuilder.Entity<Member>().Property(x => x.Id)
                .UseSqlServerIdentityColumn();
            modelBuilder.Entity<Activity>().Property(x => x.Id)
                .UseSqlServerIdentityColumn();
            modelBuilder.Entity<Team>().Property(x => x.Id)
                .UseSqlServerIdentityColumn();
            modelBuilder.Entity<MemberActivityAttendance>().Property(x => x.Id)
                .UseSqlServerIdentityColumn();
            modelBuilder.Entity<TeamActivityAttendance>().Property(x => x.Id)
                .UseSqlServerIdentityColumn();

            modelBuilder.Entity<Contest>()
                .HasMany(x => x.AttendingGroups);
            ...
            modelBuilder.Entity<Member>()
                .HasMany(x => x.ActivityResults);
            
            modelBuilder.Entity<Member>()
                .HasMany(x => x.AttendedTeams);

            modelBuilder.Entity<TeamMember>()
                .HasKey(bc => new { bc.TeamId, bc.MemberId });
